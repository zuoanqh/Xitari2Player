 ...
 * *****************************************************************************
 */
#ifndef __Pong2Player05p_HPP__
#define __Pong2Player05p_HPP__
...
class Pong2Player05pSettings : public RomSettings {

    public:

        Pong2Player05pSettings();
	...
	reward_t getRewardB() const;
        // the rom-name
        const char* rom() const { return "Pong2Player05p"; }

 ...
 * *****************************************************************************
 */
#ifndef __Pong2Player025p_HPP__
#define __Pong2Player025p_HPP__
...
class Pong2Player025pSettings : public RomSettings {

    public:

        Pong2Player025pSettings();
	...
	reward_t getRewardB() const;
        // the rom-name
        const char* rom() const { return "Pong2Player025p"; }

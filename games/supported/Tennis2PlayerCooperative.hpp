 ...
 * *****************************************************************************
 */
#ifndef __TENNIS2PLAYERCOOPERATIVE_HPP__
#define __TENNIS2PLAYERCOOPERATIVE_HPP__
...
class Tennis2PlayerCooperativeSettings : public RomSettings {

    public:

        Tennis2PlayerCooperativeSettings();
...
#endif // __TENNIS2PLAYERCOOPERATIVE_HPP__

 ...
 * *****************************************************************************
 */
#ifndef __BOXINGOFF_HPP__
#define __BOXINGOFF_HPP__
...
class Boxing2PlayerOffensiveSettings : public RomSettings {

    public:

        Boxing2PlayerOffensiveSettings();
        ...
        // the rom-name
        const char* rom() const { return "Boxing2PlayerOffensive"; }

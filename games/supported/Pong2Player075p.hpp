 ...
 * *****************************************************************************
 */
#ifndef __Pong2Player075p_HPP__
#define __Pong2Player075p_HPP__
...
class Pong2Player075pSettings : public RomSettings {

    public:

        Pong2Player075pSettings();
	...
	reward_t getRewardB() const;
        // the rom-name
        const char* rom() const { return "Pong2Player075p"; }
